...
module.exports = {
	...
	plugins: [
		...
		// Copy render.php files to build folder. ACF uses a different renderTemplate key inside the custom ACF key in the block's block.json file. This prevents the wordpress/scripts package to automatically copy the render.php file to the build folder.
		new CopyPlugin( {
			patterns: [
				{
					from: '**/render.php',
					...
					to: path.resolve(
						__dirname,
						'assets/build/blocks/[path][name][ext]'
					),
				},
			],
		} ),
